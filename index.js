	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				levelnol: '*Nivel* 0 ',}
				error: {
					stick: '[❎] Falló, como vos en el amor,
					Iv: '❌ Link inválido ❌'}
				only: {
					group: '[❗] Este comando es solo para grupos',
					ownerG: '[❗] Este comando solo puede ser utilizado por un admin dios del grupo asi que no te hagas el otro',
					ownerB: '[❗] Este comando solo lo usa BotEmolai',
					admin: '[❗] Este comando solo puede ser utilizado por un admi del grupo gil',
					Badmin: '[❗] Dame admi para utilizar este comando, tranquilo, no robare el grupó',
                                        pegatina: 'Tranquilo pa estoy haciendo tu sticker es que me saturan viste👏\n\n*Recuerda los stickersgif son de 6 segundos❗*\n\nby BotEmolai',
					attp: 'Calmeseeee pa, ya le hago su sticker es que me estreso👏\n\n*Esto puede demorar unos años, jodita ya lo mando*\n\nby BotEmolai',
					imgs: 'Euu flaco 🥴\n\n*Convirtiendo tu Sticker a Imagen 🔄*\n\nby BotEmolai',
					mpcancion: 'Paraa gil estoy procesando 😎\n\n*Convirtiendo de MP4 a MP3 🔄*\n\nBy BotEmolai',
					mpa: 'Euu flaco 🥴\n\n*Estoy decargando tu cancion 🔄*\n\nAguarde un momento, por favor\n\nby BotEmolai',
                                        xn: 'Espera pa 😎\n\n*Estoy descargando tu video 🔄*\n\nBanca un momento\n\nby BotEmolai',
					mpv: 'Calma ✋🥸🤚\n\n*Estoy descargando tu video 🔄*\n\nBanca un momento\n\nby BotEmolai',
					insta: 'Calmao 😎\n\n*Estoy descargando tu post 🔄*\n\nAguarde un momento, por favor\n\nby BotEmolai',
					musica: 'Esperaaa amigoo estoy buscando tu cancion 😎\n\n*Mas vale que hayas puesto bien el nombre de la cancion o el link❗*\n\n*Si el comando *play no funciona utiliza el comando *play2*\n\nby BotEmolai',
					musica2: 'Esperaaa amigoo estoy buscando tu cancion😎\n\n*Mas vale que hayas puesto bien el nombre de la cancion o el link❗*\n\n*Si el comando *play2 no funciona utiliza el comando *play*\n\nby BotEmolai',
